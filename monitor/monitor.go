...
type Manager interface {
	...
	Register(parent *corev1.Pod, getReferencedObjects func(*corev1.Pod) sets.String)

	Unregister(parent *corev1.Pod, getReferencedObjects func(*corev1.Pod) sets.String)
}
